...
<form action="" method="POST" name="logonForm" autocomplete="off">
			...
			<table id="tblMid" class="mid">
				...
				<tr>
					<td>
						...
						<tr>
							<td><input id="rdoPblc" value="4" name="radio" class="rdo" type="radio" checked=""></td>
							<td><label for="rdoPblc">This is a public or shared computer</label></td>
						</tr>
						<tr id="trPubExp" class="expl" style="display:none">
							<td></td>
							<td>Select this option if you use Outlook Web Access on a public 
computer. Be sure to log off when you have finished using Outlook Web 
Access and close all windows to end your session.</td>
						</tr>
						<tr>
							<td><input id="rdoPrvt" value="3" name="radio" class="rdo" type="radio"></td>
							<td><label for="rdoPrvt">This is a private computer</label></td>
						</tr>
						<tr id="trPrvtExp" class="expl" style="display:none">
							<td></td>
							<td>Select this option if you are the only person who uses this 
					...
					<td>
						<table class="nonMSIE">
							...
							<col class="w100">
									...
									<td><input id="chkBsc" class="rdo" disabled="disabled" checked="checked" type="checkbox"></td>
									<td nowrap="nowrap"><label for="chkBsc">Use Outlook Web Access Light</label></td>
								</tr>
								<tr id="trBscExp" class="disBsc">
									<td></td>
									<td>The Light client provides fewer features and is sometimes 
faster. Use the Light client if you are on a slow connection or using a 
computer with unusually strict browser security settings. If you are 
using a browser other than Internet Explorer 6 or later, you can only 
use the Light client.</td>
							</tr>
					...
					<td>
						<table class="nonMSIE">
							...
							<col>
								...
								<td nowrap="nowrap"><label for="username">E-mail Address:</label></td>
