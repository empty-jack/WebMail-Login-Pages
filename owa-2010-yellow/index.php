...
<link type="text/css" rel="stylesheet" href="owafont.css">
...
<table id="tblMain" cellpadding="0" cellspacing="0" align="center">
	<tbody><tr>
		<td colspan="3">
			<table class="tblLgn" cellpadding="0" cellspacing="0">
			<tbody><tr>
			...
			<table id="tblMid" class="mid">
				...
				<tr>
					<td>
						...
						<col class="w100">
							...
							<td colspan="2">
								Security 
									...
									<a href="#" id="lnkHdSec" style="display:none">
									hide explanation 
									</a>
								)‎
							</td>
						...
						<tr>
							<td><input id="rdoPblc" name="radio" value="0" class="rdo" checked="checked" type="radio"></td>
							<td><label for="rdoPblc">This is a public or shared computer</label></td>
						</tr>
						<tr id="trPubExp" class="expl" style="display:none">
							<td></td>
							<td>Select this option if you use Outlook Web App on a public 
computer. Be sure to sign out when you've finished and close all windows
 to end your session.</td>
						</tr>
						<tr>
							<td><input id="rdoPrvt" name="radio" value="4" class="rdo" type="radio"></td>
							<td><label for="rdoPrvt">This is a private computer</label></td>
						</tr>
						<tr id="trPrvtExp" class="expl" style="display:none">
							<td></td>
							<td>Select this option if you're the only person who uses this 
					...
					<td>
						<table cellpadding="0" cellspacing="0">
							...
							<col class="w100">
									...
									<td><input id="chkBsc" class="rdo" type="checkbox"></td>
									<td nowrap="nowrap"><label for="chkBsc">Use the light version of Outlook Web App</label></td>
								</tr>
								<tr id="trBscExp" class="disBsc" style="display:none">
									<td></td>
									<td>The light version of Outlook Web App includes fewer 
...
systems, <a href="http://go.microsoft.com/fwlink/?LinkID=129362" id="bscLnk">click here.</a></td>
								</tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0">
							...
							<col>
								...
								<td nowrap="nowrap"><label for="username">User name:</label></td>
								<td class="txtpad"><input id="username" name="username" class="txt" type="text"></td>
							</tr>
							<tr>
								<td nowrap="nowrap"><label for="password">Password:</label></td>
								<td class="txtpad"><input id="password" name="password" class="txt" type="password"></td>
							</tr>
							</tbody></table>
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tbody><tr>
								<!-- <td align="left" nowrap="nowrap" width="75%">
								Click <a href="#" target="_blank">here</a> to reset your password.
								</td> -->
								<td class="txtpad" align="right" nowrap="nowrap" width="25%">
									
									<input class="btn" value="Sign in" onmouseover="this.className='btnOnMseOvr'" onmouseout="this.className='btn'" onmousedown="this.className='btnOnMseDwn'" type="submit">
			...
			<table id="tblMid2" class="mid" style="display:none">
				...
				<tr>
					<td class="txtpad" align="right">
						...
						<input class="btn" style="float: right" value="Retry" onmouseover="this.className='btnOnMseOvr'" onmouseout="this.className='btn'" onmousedown="this.className='btnOnMseDwn'" type="button">
			...
			Usage is subject to security testing and monitoring. Misuse is<br>
			subject to criminal prosecution. Users have no expectation of<br>
			privacy except as otherwise provided by applicable privacy laws.<br>
			</td>
			</tr>
			</tbody></table>
